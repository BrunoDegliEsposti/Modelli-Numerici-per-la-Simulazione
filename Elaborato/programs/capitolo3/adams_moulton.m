function [yT,tab] = adams_moulton(odefun,t0,T,h,y0,k)
%ADAMS_MOULTON Metodo di Adams-Moulton a k passi e passo temporale h per
...
% tutte le iterazioni effettuate dal metodo.
    ...
    [alpha,beta,order] = adams_moulton_coefficients(k);
    if save_table
