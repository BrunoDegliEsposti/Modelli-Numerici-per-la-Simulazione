...
% quindi ha errore relativo dell'ordine di sqrt(eps), a patto che le derivate
% del primo e secondo ordine in (t0,y0) siano trascurabili nell'analisi dell'errore.
    m = length(y0);
    Jf = zeros(m,m);
    f0 = f(t0,y0);
